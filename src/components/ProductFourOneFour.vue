  ...
  <div class="products-group-4-1-4 space-1 bg-gray-7">
    <div class="container">
      ...
      <div class="position-relative text-center z-index-2 mb-3">
        <ul
          class="nav nav-classic nav-tab nav-tab-sm px-md-3 justify-content-start justify-content-lg-center flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble border-md-down-bottom-0 pb-1 pb-lg-0 mb-n1 mb-lg-0"
          id="pills-tab-1"
          role="tablist"
        >
      ...
      <div class="tab-content" id="Tpills-tabContent">
        <div
          class="tab-pane fade pt-2 active show"
        ...
        >
          <div class="row no-gutters">
            <div class="col-md-3 col-wd-4 d-md-flex d-wd-block">
              ...
              >
                <li
                  class="col-xl-6 product-item max-width-xl-100 remove-divider"
                >
                  <div
                    class="product-item__outer h-100 w-100 prodcut-box-shadow"
                  >
                        ...
                        >
                          <a
                            ...
                            ><i
                              ...
                              class="fa-solid fa-code-compare mr-1 font-size-15"
                            ></i>
                            Compare</a
                          >
                          <a
                            ...
                            class="text-gray-6 font-size-13"
                            ><i
                              class="mr-1 font-size-15 fa-regular fa-heart"
                            ></i>
                            Add to Wishlist</a
                          >
                        </div>
                      ...
                      <div class="product-item__body pb-xl-2">
                        ...
                        <h5 class="mb-1 product-item__title">
                          <a
                            href="../shop/single-product-fullwidth.html"
                            class="text-blue font-weight-bold"
                            >GameConsole Destiny Special Edition</a
                          >
                        </h5>
                        <div class="mb-2">
                          <a
            ...
            <div class="col-md-6 col-wd-4 products-group-1">
              <ul
                class="row list-unstyled products-group no-gutters bg-white h-100 mb-0"
              >
                      ...
                      <div class="product-item__body d-flex flex-column">
                        <div class="mb-1">
                          ...
                          <h5 class="mb-0 product-item__title">
                            <a
                              href="../shop/single-product-fullwidth.html"
                              class="text-blue font-weight-bold"
                              >Game Console Controller + USB 3.0 Cable</a
                            >
                          </h5>
                        </div>
                        <div class="mb-1 min-height-4-1-4">
                          <a
                            ...
                            ><img
                              class="img-fluid"
                              src="https://transvelo.github.io/electro-html/2.0/assets/img/564X520/img2.jpg"
                              alt="Image Description"
                          /></a>
                          <!-- Gallery -->
                          <div class="row mx-gutters-2 mb-3">
                            <div class="col-auto">
                              ...
                              <a
                                ...
                                href="javascript:;"
                                data-src="https://transvelo.github.io/electro-html/2.0/assets/img/1920X1080/img1.jpg"
                              ...
                              >
                                <img
                                  ...
                                  src="https://transvelo.github.io/electro-html/2.0/assets/img/100X100/img1.jpg"
                                  alt="Image Description"
                                />
                                ...
                                <span class="u-media-viewer__container">
                                  <span class="u-media-viewer__icon">
                                    <span
                                      class="fas fa-plus u-media-viewer__icon-inner"
                                    ></span>
                                  </span>
                                </span>
                              </a>
                            ...
                            <div class="col-auto">
                              ...
                              <a
                                class="js-fancybox max-width-60 u-media-viewer"
                                href="javascript:;"
                                data-src="https://transvelo.github.io/electro-html/2.0/assets/img/1920X1080/img2.jpg"
                                data-fancybox="fancyboxGallery6"
                              ...
                              >
                                <img
                                  class="img-fluid border"
                                  src="https://transvelo.github.io/electro-html/2.0/assets/img/100X100/img2.jpg"
                                  alt="Image Description"
                                />
                            ...
                            <div class="col-auto">
                              ...
                              <a
                                class="js-fancybox max-width-60 u-media-viewer"
                                href="javascript:;"
                                data-src="https://transvelo.github.io/electro-html/2.0/assets/img/1920X1080/img3.jpg"
                                data-fancybox="fancyboxGallery6"
                              ...
                              >
                                <img
                                  class="img-fluid border"
                                  src="https://transvelo.github.io/electro-html/2.0/assets/img/100X100/img3.jpg"
                                  alt="Image Description"
                                />
      ...
      <div class="tab-content" id="Gpills-tabContent">
        ...
        >
          <div class="row no-gutters">
            <div class="col-md-3 col-wd-4 d-md-flex d-wd-block">
              <ul
                class="row list-unstyled products-group no-gutters mb-0 w-100"
              >
                  ...
                  <div class="h-100 w-100 prodcut-box-shadow">
                    <div class="bg-white p-3">
                      <div class="pb-xl-2">
                        <div class="mb-2">
                          <div
                            class="bg-gray-1 bg-animation rounded height-10 w-60"
                          ></div>
                        </div>
                        <div class="mb-3">
                          <div
                            class="bg-gray-1 bg-animation rounded height-12 mb-1"
                          ></div>
                          <div
                        ...
                        <div class="flex-center-between mb-1">
                          <div
                            class="bg-gray-1 bg-animation rounded height-20 w-60"
                          ></div>
                          <div
                            class="bg-gray-1 height-35 width-35 rounded-circle"
                          ></div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="h-100 w-100 prodcut-box-shadow">
                    <div class="bg-white p-3">
                      <div class="d-flex flex-column">
                        ...
                        <div class="flex-center-between">
                          <div
                            class="bg-gray-1 bg-animation rounded height-20 w-40"
                          ></div>
                          <div
                            class="bg-gray-1 height-35 width-134 rounded-pill"
                          ></div>
                        </div>
                      </div>
                    </div>
